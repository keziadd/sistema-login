                ...
                <nav class="navbar bg-light">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="index.php">
                            <img src="img/bootstrap-logo.svg" alt="logo-bootstrap" width="30" height="24" class="d-inline-block align-text-top">
                            Sistema Web 2.0
                        </a>
                    </div>
                </nav>
                    ...
                    <p>
                        ...
                        <form class="row g-3" method="post" action="controller/ControllerCadastro.php?funcao=editar&id=<?php echo $result[0]['id']; ?>" id="form" name="form">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="txtEstado"  class="form-select" name="txtEstado" class="form-select" value="<?php echo $result[0]['estado']; ?>">
